...
export default function AdminDashboard({
      ...
      const booksToSeed = [
        {
          ...
          category: "الفقه",
          description:
            "كتاب جامع يتناول أعمال القلوب وأثرها في السلوك والعبادة، بأسلوب وعظي رقيق يجمع بين الدليل الشرعي واللطائف الإيمانية.",
          imageUrl:
            "https://images.unsplash.com/photo-1544640808-32ca72ac7f37?q=80&w=1000&auto=format&fit=crop",
          pdfUrl: "#",
        ...
        },
        {
          ...
          category: "السيرة",
          description:
            "دراسة تحليلية لسيرة النبي صلى الله عليه وسلم، تركز على الدروس والعبر المستفادة من المواقف النبوية في التربية والدعوة.",
          imageUrl:
        ...
        },
        {
          ...
          description:
            "دليل عملي للمسلم في حياته اليومية، يجمع بين الأصالة والمعاصرة في فهم وتطبيق أحكام الإسلام.",
          imageUrl:
      ...
      const audioToSeed = [
        {
          ...
          category: "العقيدة",
          description:
            "الدرس الأول من سلسلة شرح أسماء الله الحسنى، يتناول أهمية معرفة الله وأثرها في حياة المسلم.",
        ...
        },
        {
          ...
          category: "الرقائق",
          description:
            "خطبة مؤثرة تتناول فضل الصبر على البلاء وعظيم أجر المحتسبين عند الله تعالى.",
        ...
        },
        {
          ...
          category: "التفسير",
          description:
            "وقفة تدبرية مع أم الكتاب، نستعرض فيها معانيها العظيمة وأسرارها البديعة.",
      ...
      const videosToSeed = [
        {
          ...
          category: "لقاءات",
          description:
            "حوار مفتوح حول التحديات التي تواجه الشباب المسلم المعاصر وكيفية استثمار الطاقات في خدمة الدين والوطن.",
        ...
        },
        {
          ...
          category: "ندوات",
          description:
            "شرح مفصل لمقاصد الشريعة الإسلامية في باب المعاملات المالية، مع تطبيقات معاصرة.",
          youtubeUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
          createdAt: serverTimestamp(),
        },
        {
          ...
          category: "خطب",
          description:
            "خطبة عيد الفطر المبارك، تتناول معاني الفرح المشروعة وأهمية التواصل والتراحم بين المسلمين.",
          youtubeUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
          createdAt: serverTimestamp(),
        },
      ];
      ...
      const pamphletsToSeed = [
        {
          ...
          description:
            "مطوية جامعة للأذكار الصحيحة الواردة عن النبي صلى الله عليه وسلم في الصباح والمساء.",
          imageUrl:
            "https://images.unsplash.com/photo-1544640808-32ca72ac7f37?q=80&w=1000&auto=format&fit=crop",
          pdfUrl: "#",
          createdAt: serverTimestamp(),
        },
        {
          ...
          description:
            "نصائح وتوجيهات عملية لاستثمار شهر رمضان المبارك في الطاعات والتقرب إلى الله.",
          imageUrl:
            "https://images.unsplash.com/photo-1585036156171-384164a8c675?q=80&w=1000&auto=format&fit=crop",
          pdfUrl: "#",
          createdAt: serverTimestamp(),
        },
        {
          ...
          description:
            "مختصر للأدعية والأذكار التي يحتاجها المسلم في يومه وليله.",
          imageUrl:
            "https://images.unsplash.com/photo-1532012197267-da84d127e765?q=80&w=1000&auto=format&fit=crop",
          pdfUrl: "#",
          createdAt: serverTimestamp(),
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const firestoreCollection =
        activeTab === "overview" ? "" : collectionMap[activeTab];
      ...
      handleFirestoreError(
        ...
        `${firestoreCollection}/${deleteModal?.id}`,
      );
    } finally {
      setIsDeleting(false);
    }
  ...
  if (!user) {
    return (
      <div
        className="min-h-screen flex items-center justify-center relative font-cairo"
        dir="rtl"
      >
        ...
        <div className="relative z-10 bg-white p-6 md:p-10 md:p-12 rounded-[20px] shadow-[0_8px_30px_rgb(0,0,0,0.12)] max-w-[480px] w-full mx-4 flex flex-col items-center">
          ...
          {/* Titles */}
          <h1 className="text-2xl md:text-3xl font-semibold text-emerald-950 mb-3 text-center font-cairo">
            الدخول إلى لوحة الإدارة
          </h1>
          <p className="text-base md:text-lg text-emerald-600 mb-8 text-center leading-relaxed font-cairo">
            يرجى تسجيل الدخول للوصول إلى لوحة التحكم وإدارة محتوى الموقع من كتب
            ودروس ومحاضرات.
          </p>
          ...
          >
            <div className="space-y-2">
              <label className="block text-[14px] text-emerald-800 font-medium">
                البريد الإلكتروني
              </label>
              <input
                type="email"
            ...
            <div className="pt-4 space-y-4">
              <button
                type="button"
                onClick={() =>
                  alert("يرجى استخدام تسجيل الدخول بواسطة Google حالياً")
                }
              ...
              <div className="relative flex items-center py-2">
                ...
                <span className="flex-shrink-0 mx-4 text-emerald-400 text-sm">
                  أو
                </span>
                <div className="flex-grow border-t border-emerald-100"></div>
              </div>
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            ...
            <p className="text-emerald-400 text-[13px]">© جميع الحقوق محفوظة</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] font-cairo flex" dir="rtl">
      ...
      {/* Sidebar */}
      <aside
        className={`w-72 bg-emerald-950 text-white flex flex-col fixed right-0 h-full z-30 transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full md:translate-x-0"}`}
      >
        <div
          onClick={() => onNavigate("home")}
      ...
      <main className="flex-1 md:mr-72 flex flex-col min-h-screen w-full overflow-x-hidden">
          ...
          <div className="flex items-center gap-3 md:gap-6">
                ...
                {showNotifications && (
                  ...
                  >
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      ...
                      <div className="p-4 border-b border-emerald-50 hover:bg-emerald-50/30 transition-colors cursor-pointer">
                        <p className="text-sm text-emerald-900 font-medium mb-1">
                          تم تسجيل دخول جديد للوحة التحكم
                        </p>
            ...
            <div className="hidden md:flex items-center gap-3 px-4 border-x border-emerald-100">
              <div className="text-left">
                <p className="text-base md:text-lg font-bold text-emerald-950 leading-tight">
                  {user.displayName || "المدير العام"}
                </p>
                <p className="text-sm md:text-base text-emerald-500">
                  {user.email}
                </p>
              </div>
        ...
        <div className="p-4 md:p-8 flex-1">
          <AnimatePresence mode="wait">
            ...
            >
              {activeTab === "overview" && (
                <OverviewTab setDeleteModal={setDeleteModal} />
              )}

              {activeTab === "books" && !isAdding && (
                <BooksList
                  onAdd={() => {
                    setIsAdding(true);
                    setItemToEdit(null);
              ...
              {activeTab === "reflections" && !isAdding && (
                <ReflectionsList
                  onAdd={() => {
                    setIsAdding(true);
                    setItemToEdit(null);
              ...
              {activeTab === "messages" && (
                <MessagesList setDeleteModal={setDeleteModal} />
              )}
            </motion.div>
          </AnimatePresence>
        </div>
          ...
          {deleteModal && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              >
                ...
                <h3 className={typo.h2 + " text-emerald-950 mb-2"}>
                  تأكيد الحذف
                </h3>
...
const OverviewTab = ({
  ...
  const { data: reflections } = useFirestoreCollection(
    "reflections",
    setDeleteModal,
  );
  const { data: pamphlets } = useFirestoreCollection(
    "pamphlets",
    setDeleteModal,
  );
  ...
  const stats = [
    ...
    {
      title: "الدروس الصوتية",
      count: audio.length.toString(),
      icon: Mic,
    ...
    {
      title: "الخواطر",
      count: reflections.length.toString(),
      icon: FileText,
      color: "bg-gold-50 text-gold-600",
    },
    {
      title: "المطويات",
      count: pamphlets.length.toString(),
      icon: ImageIcon,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-6">
      {stats.map((stat, i) => (
        <div
          key={i}
          className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-emerald-50 flex items-center gap-4"
        >
          <div
          ...
          <div>
            <p className={typo.small + " text-emerald-600 mb-1"}>
              {stat.title}
            </p>
            <h3 className={typo.h2 + " text-emerald-950 leading-none"}>
              {stat.count}
            </h3>
          </div>
        </div>
...
const BooksList = ({
  ...
  const {
    ...
    loading,
    handleDeleteClick,
  } = useFirestoreCollection("books", setDeleteModal);
  const [searchQuery, setSearchQuery] = useState("");
  const [activeCategory, setActiveCategory] = useState("الكل");

  if (loading)
    return (
      <div className="p-8 text-center text-emerald-600">جاري التحميل...</div>
    );
        ...
        <table className="w-full text-right min-w-max">
          <thead>
            <tr className="border-b border-emerald-100 text-emerald-600">
              <th
                className={`pb-4 font-medium whitespace-nowrap px-2 ${typo.body}`}
              >
                الغلاف
              </th>
              <th
          ...
          <tbody className="divide-y divide-emerald-50">
            {filteredBooks.length === 0 ? (
              <tr>
                <td colSpan={6} className="py-8 text-center text-emerald-500">
              ...
              filteredBooks.map((book) => (
                ...
                >
                  ...
                  <td
                    className={`py-4 px-2 text-emerald-950 whitespace-nowrap ${typo.body}`}
                  >
                    {book.title}
                  </td>
                  <td
                    className={`py-4 px-2 text-emerald-600 whitespace-nowrap ${typo.body}`}
                  >
                    {book.author || "---"}
                  </td>
                  <td
...
const AudioList = ({
  ...
  const {
    ...
    loading,
    handleDeleteClick,
  } = useFirestoreCollection("audio", setDeleteModal);
  const [searchQuery, setSearchQuery] = useState("");
  const [activeCategory, setActiveCategory] = useState("الكل");
        ...
        <table className="w-full text-right min-w-max">
          ...
          <tbody className="divide-y divide-emerald-50">
            {filteredAudio.length === 0 ? (
              <tr>
                <td colSpan={4} className="py-8 text-center text-emerald-500">
                  لا توجد نتائج مطابقة للبحث.
                </td>
              </tr>
            ) : (
...
const VideoList = ({
  ...
  const {
    ...
    loading,
    handleDeleteClick,
  } = useFirestoreCollection("videos", setDeleteModal);
  const [searchQuery, setSearchQuery] = useState("");
  const [activeCategory, setActiveCategory] = useState("الكل");
...
const ReflectionsList = ({
  ...
  const {
    ...
    loading,
    handleDeleteClick,
  } = useFirestoreCollection("reflections", setDeleteModal);
  const [searchQuery, setSearchQuery] = useState("");
  const [activeCategory, setActiveCategory] = useState("الكل");
...
const PamphletsList = ({
  ...
  const {
    ...
    loading,
    handleDeleteClick,
  } = useFirestoreCollection("pamphlets", setDeleteModal);
  const [searchQuery, setSearchQuery] = useState("");
...
const MessagesList = ({
  ...
  const {
    ...
    loading,
    handleDeleteClick,
  } = useFirestoreCollection("messages", setDeleteModal);
      ...
      <div className="overflow-x-auto -mx-4 px-4 md:mx-0 md:px-0">
        <table className="w-full text-right min-w-max">
          ...
          <tbody className="divide-y divide-emerald-50">
            {messages.length === 0 ? (
              <tr>
                <td colSpan={5} className="py-8 text-center text-emerald-500">
                  لا توجد رسائل بعد.
                </td>
              </tr>
            ) : (
              messages.map((msg) => (
                ...
                >
                  ...
                  <td
                    className={`py-4 px-2 text-emerald-600 whitespace-nowrap ${typo.body} max-w-xs truncate`}
                  >
                    {msg.message}
                  </td>
                  <td
...
const FormWrapper = ({
  ...
  <div className="bg-white rounded-2xl shadow-sm border border-emerald-50 p-4 md:p-8 max-w-4xl mx-auto">
    <div className="flex justify-between items-center mb-6 md:mb-8 pb-4 border-b border-emerald-50">
      ...
      <button
        onClick={onCancel}
        className="p-2 text-emerald-400 hover:text-emerald-900 transition-colors rounded-full hover:bg-emerald-50"
      >
        <X className="w-6 h-6" />
      </button>
    </div>
    <form className="space-y-6" onSubmit={onSubmit}>
      ...
      <div className="pt-6 flex flex-col sm:flex-row gap-4">
        <button
          disabled={loading}
          type="submit"
          className={`w-full sm:w-auto justify-center bg-emerald-800 text-white px-8 py-3 rounded-xl hover:bg-emerald-900 transition-colors flex items-center gap-2 ${typo.button} ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
        >
        ...
        <button
          type="button"
          onClick={onCancel}
          className={`w-full sm:w-auto justify-center bg-emerald-50 text-emerald-800 px-8 py-3 rounded-xl hover:bg-emerald-100 transition-colors ${typo.button}`}
        >
          إلغاء
        </button>
      </div>
...
const Input = ({
  ...
  <div>
    <label className={`block text-emerald-900 mb-2 ${typo.body}`}>
      {label}
    </label>
    <input
      type={type}
...
const Select = ({
  ...
  <div>
    ...
    <select
      ...
      onChange={onChange}
      required={required}
      className={`w-full bg-emerald-50/50 border border-emerald-100 rounded-xl pr-4 pl-10 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23065f46%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')] bg-[position:left_0.75rem_center] bg-[length:1.25em_1.25em] bg-no-repeat ${typo.body}`}
    >
...
const AddBookForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (coverFile) {
        const coverRef = ref(
          storage,
          `books/covers/${Date.now()}_${coverFile.name}`,
        );
      ...
      if (error.code === "permission-denied") {
        errorMsg =
          "ليس لديك صلاحية للقيام بهذه العملية. يرجى التأكد من تسجيل الدخول بحساب المشرف.";
      ...
      handleFirestoreError(
        error,
        itemToEdit ? OperationType.UPDATE : OperationType.CREATE,
        `books/${itemToEdit?.id || ""}`,
      );
    } finally {
      setLoading(false);
  ...
  return (
    <FormWrapper
      title={itemToEdit ? "تعديل كتاب" : "إضافة كتاب جديد"}
      onCancel={onCancel}
...
const AddAudioForm = ({
  ...
  return (
    <FormWrapper
      title={itemToEdit ? "تعديل صوتية" : "إضافة درس صوتي جديد"}
      onCancel={onCancel}
      onSubmit={handleSubmit}
      loading={loading}
    >
      <Input
        label="عنوان الدرس"
        placeholder="أدخل عنوان الدرس الصوتي..."
        value={title}
        onChange={(e) => setTitle(e.target.value)}
        required
      />
      <Select
        label="التصنيف"
        options={["العقيدة", "الآداب والأخلاق", "خطب الجمعة", "دروس علمية"]}
        value={category}
        onChange={(e) => setCategory(e.target.value)}
        required
      />
      <Input
        label="رابط SoundCloud"
...
const AddVideoForm = ({
  ...
  return (
    <FormWrapper
      title={itemToEdit ? "تعديل مقطع مرئي" : "إضافة مقطع مرئي جديد"}
      onCancel={onCancel}
      onSubmit={handleSubmit}
      loading={loading}
    >
      <Input
        label="عنوان المقطع"
        placeholder="أدخل عنوان المقطع المرئي..."
        value={title}
        onChange={(e) => setTitle(e.target.value)}
        required
      />
      <Select
        label="التصنيف"
        options={["محاضرات عامة", "خطب الجمعة", "دروس علمية"]}
        value={category}
        onChange={(e) => setCategory(e.target.value)}
        required
      />
      ...
      <Textarea
        label="وصف المقطع"
        placeholder="نبذة مختصرة عن محتوى المقطع..."
        value={description}
        onChange={(e) => setDescription(e.target.value)}
        required
      />
...
const AddReflectionForm = ({
  ...
  return (
    <FormWrapper
      title={itemToEdit ? "تعديل خاطرة" : "إضافة خاطرة جديدة"}
      onCancel={onCancel}
      onSubmit={handleSubmit}
      loading={loading}
    >
      <Input
        label="عنوان الخاطرة"
        placeholder="أدخل عنوان الخاطرة..."
        value={title}
        onChange={(e) => setTitle(e.target.value)}
        required
      />
      <Select
        label="التصنيف"
        options={["إيمانيات", "قرآنيات", "تربويات", "أخلاقيات"]}
        value={category}
        onChange={(e) => setCategory(e.target.value)}
        required
      />
      <Textarea
        label="نص الخاطرة"
        placeholder="اكتب نص الخاطرة هنا..."
        rows={8}
        value={text}
...
const AddPamphletForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (coverFile) {
        const coverRef = ref(
          storage,
          `pamphlets/covers/${Date.now()}_${coverFile.name}`,
        );
        await uploadBytes(coverRef, coverFile);
        coverUrl = await getDownloadURL(coverRef);
      }
      ...
      if (pdfFile) {
        const pdfRef = ref(
          storage,
          `pamphlets/pdfs/${Date.now()}_${pdfFile.name}`,
        );
        await uploadBytes(pdfRef, pdfFile);
        pdfUrl = await getDownloadURL(pdfRef);
      }
  ...
  return (
    <FormWrapper
      title={itemToEdit ? "تعديل مطوية" : "إضافة مطوية جديدة"}
      onCancel={onCancel}
      onSubmit={handleSubmit}
      loading={loading}
    >
      <Input
        label="عنوان المطوية"
        placeholder="أدخل عنوان المطوية..."
        value={title}
        onChange={(e) => setTitle(e.target.value)}
        required
      />
      <Textarea
        label="وصف المطوية"
        placeholder="نبذة مختصرة عن المطوية..."
        value={description}
        onChange={(e) => setDescription(e.target.value)}
        required
      />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <FileUpload
          label="صورة العرض (Preview)"
          accept="image/*"
          onChange={setCoverFile}
          file={coverFile}
        />
        <FileUpload
          label="ملف المطوية (PDF)"
          accept=".pdf"
          onChange={setPdfFile}
          file={pdfFile}
        />
